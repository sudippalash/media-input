...
<div class="card">
    <div class="card-header">
        ...
        <div class="dropdown float-right">
            <a href="javascript:void(0);" class="dropdown-toggle" id="spDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                {{ trans('media-input::media_input.add_media_from_url') }} <span class="caret"></span>
            </a>
            <div class="dropdown-menu" aria-labelledby="spDropdown">
                <a href="javascript:void(0);" class="dropdown-item" data-toggle="modal" data-target="#spImageModal{{ $uniqueId }}">
                    {{ trans('media-input::media_input.image_from_url') }}
                </a>
                <a href="javascript:void(0);" class="dropdown-item" data-toggle="modal" data-target="#spVideoModal{{ $uniqueId }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ trans('media-input::media_input.cancel') }}</button>
